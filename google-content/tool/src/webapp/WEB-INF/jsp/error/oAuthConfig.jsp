...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
  ...
  <body onload="loaded();">
    <div class="portletBody">
      <h3>Google Documents OAuth Configuration Error</h3>
      <p class="instruction indnt2">
        The configuration for connecting to the Google Documents service is in error.  Please contact your administrator.
        <%
            Exception
