...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
   <head>
      ...
      <link href="/library/skin/default/mcc.css"  type="text/css" rel="stylesheet" media="all"/>
      <link href="${sakai_skin_base}"             type="text/css" rel="stylesheet" media="all"/>
      <link href="${sakai_skin}"                  type="text/css" rel="stylesheet" media="all"/>
